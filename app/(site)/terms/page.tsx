...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-20">
      <h1 className="font-josefin text-3xl tracking-widest uppercase mb-2">Terms & Conditions</h1>
      ...
      <div className="space-y-10 font-cormorant text-lg leading-relaxed text-gray-700">
        ...
        <section>
          ...
          <p>We accept returns within 14 days of delivery for unworn, undamaged items in original condition. To initiate a return, contact us at storenavaria@gmail.com. Return shipping costs are the buyer's responsibility unless the item is faulty.</p>
        </section>
        ...
        <section>
          ...
          <p>For any questions about your order or these terms, reach us at storenavaria@gmail.com.</p>
        </section>
